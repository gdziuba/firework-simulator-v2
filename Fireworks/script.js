...
ws.onmessage = function(e) {
    if (e.data === 'trigger-firework') {
        // Regular firework trigger
        // ... your existing firework trigger code ...
		seqRandomFastShell();
    } else if (e.data === 'trigger-special-firework-1') {
        // Special firework trigger
        seqTwoRandom();  // Call the special firework function
    } else if (e.data === 'trigger-special-firework-2') {
        // Special firework trigger
        seqTriple();  // Call the special firework function
    } else if (e.data === 'trigger-special-firework-3') {
        // Special firework trigger
        seqSmallBarrage();  // Call the special firework function
    }
};
